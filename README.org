...
*** Method 1 - Bootstrap installer 
 ...
 - 1. Just evaluate this code in the scratch buffer that will install
   all dependencies and this package.
...
#+END_SRC
 ...
 - 2. =M-x make-directory= ~/org/wiki and create the wiki location if it doesn't exist yet.

 - 3. Add this lines to ~/emacs.d/init.el 

#+BEGIN_SRC elisp 
(require 'org-wiki)
(setq org-wiki/location "~/org/wiki") ;; Or M-x customize-group org-wiki
#+END_SRC
