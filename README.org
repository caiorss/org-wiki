...
Org-mode has many features that makes it suitable to create a desktop
...
** Commands
  ...
  - =M-x org-wiki/insert-asset= - Insert a asset file at point
...
#+BEGIN_SRC elisp 
(defalias 'w-i #'org-wiki/insert)
#+END_SRC

 - Open the current wiki page assets directory: =M-x ad=
