...
Just evaluate this code in the scratch buffer that will install all dependencies and this package.
...
This bookmarklet when executed opens a prompt and creates an org-mode
hyperlink code for the current web page. 
